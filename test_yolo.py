...
data_yaml = Path("/home/jovyan/nfs/mgatti/datasets/skin_lesion_dataset/yolo/skin_lesion.yaml")
gt_json = Path("/home/jovyan/nfs/mgatti/datasets/skin_lesion_dataset/coco/annotations/instances_test.json")
